...
import { LayoutDashboard, Users, LogOut, LockKeyhole, Tags, ShieldAlert, BookOpen, Briefcase } from 'lucide-react';
      ...
      <div className="p-3 border-t border-sidebar-border">
        <div className="flex items-center gap-3 p-2.5 rounded-lg bg-sidebar-accent/50 border border-sidebar-border transition-all hover:bg-sidebar-accent cursor-default">
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <div className="text-xs font-medium text-muted-foreground uppercase truncate">{user?.role}</div>
          </div>
