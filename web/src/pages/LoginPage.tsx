      ...
      >
        <div className="flex flex-col items-center mb-10 space-y-4">
          ...
          <div className="text-center">
            ...
            <p className="text-sm uppercase tracking-[0.4em] text-muted-foreground/60 font-bold mt-2 ml-1">
              Universal Secrets Infrastructure
            </p>
          </div>
        </div>
            ...
            <form id="auth-form" onSubmit={handleSubmit} className="space-y-6">
              ...
              {error && (
                ...
                >
                  <Alert
                    variant="destructive"
                    className="rounded-2xl bg-destructive/5 border-destructive/20 py-4"
                  >
        ...
        <div className="text-center mt-8 text-muted-foreground/40 text-xs font-mono">
          SECURE PROTOCOL // AES-256-GCM ENCRYPTED
        </div>
      </motion.div>
    </div>
  );
